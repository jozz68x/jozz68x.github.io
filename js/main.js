...
$(document).ready(function () {
    ...
    let $toolbarIcon = $('.toolbar #ic-hamburger');
    let $drawer = $('#drawer-main');
    let $dimScreenDrawer = $('#dim-screen-drawer');
    ...
    let setupSelectItems = () => {
        ...
        $itemDrawerHome.on('click', function (e) {
            e.preventDefault();
            cleanItems();
        ...
        function cleanItems() {
            $.each([0, 2, 4, 6, 8, 10], function (index, value) {
                $('#drawer-menu').find('li:eq(' + value + ')').has('a').children().removeClass(
                    'active');
            });
    ...
    let setupValidateStorageAndLoad = () => {
